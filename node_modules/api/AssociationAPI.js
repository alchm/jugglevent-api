...
define([
    ...
    exports.getById = function (aId, done) {
        Association.findOne({ _id: aId }, function (err, a) {
            if (!err) {
                if (a) done (null, a);
    ...
    exports.updateById = function (aId, aData, done) {
        Association.findOne({ _id: aId }, function (err, a) {
            if (!err) {
                if (a) updateObject(a,aData, function (a) {
                    a.save(function (err) {
                        if (!err) done(null, a);
                        else done (err, null);
                    });
    ...
    exports.deleteById = function (aId, done) {
        Association.remove({ _id: aId }, function (err, a) {
            if (!err) done(null, a);
            else done(err, null);
        });
    };

    function updateObject(obj, data, done) {
