...
define([
    ...
    exports.getByUsername = function(userUsername, done) {
        User.findOne({ username: userUsername }, function(err, data) {
            done(err, data);
        });
    };
    ...
    exports.deleteById = function (userId, done) {
        User.remove({ _id: userId }, function (err, a) {
            if (!err) done(null, a);
            else done(err, null);
        });
    };
